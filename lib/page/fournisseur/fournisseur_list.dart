...
class _FournisseurListState extends ConsumerState<FournisseurList> {
  ...
  void _showAddDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => const EditFournisseurDialog(),
    );
  }

  void _handlePopupSelection(String value, BuildContext context, Fournisseur fournisseur) {
    switch (value) {
      case 'detail':
      ...
      case 'modifier':
        showDialog(
          context: context,
          builder: (context) => EditFournisseurDialog(fournisseur: fournisseur),
        );
        break;
      case 'appeler':
  ...
  void _showDetails(BuildContext context, Fournisseur fournisseur) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Détails - ${fournisseur.nom}'),
        content: Column(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              await _deleteFournisseur(context, fournisseur);
            },
  ...
  Future<void> _deleteFournisseur(BuildContext context, Fournisseur fournisseur) async {
    try {
      final controller = ref.read(fournisseurControllerProvider.notifier);
      await controller.deleteFournisseur(fournisseur.id, fournisseur.entrepriseId);
