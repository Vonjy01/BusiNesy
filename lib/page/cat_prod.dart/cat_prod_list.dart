// lib/page/categorie_produit/categorie_produit_list.dart
...
class _CategorieProduitListState extends ConsumerState<CategorieProduitList> {
  ...
  void _showAddDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => const CategorieDialog(),
    );
  }

  void _handlePopupSelection(String value, BuildContext context, CategorieProduit categorie) {
    switch (value) {
      case 'modifier':
        showDialog(
          context: context,
          builder: (context) => CategorieDialog(categorie: categorie),
        );
        break;
      case 'supprimer':
        _confirmDelete(context, categorie);
        break;
    }
  }

  Future<void> _confirmDelete(BuildContext context, CategorieProduit categorie) async {
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              await _deleteCategorie(context, categorie);
            },
  ...
  Future<void> _deleteCategorie(BuildContext context, CategorieProduit categorie) async {
    try {
      await ref.read(categorieProduitControllerProvider.notifier)
          .deleteCategorie(categorie.id!, categorie.entrepriseId);
